    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(string go)
        {
            if (!String.IsNullOrWhiteSpace(go))
            {
                ...
                string redirectUri = "http://localhost/Promo/Home/Exchange";
                string scope = "Read.Contacts";

                //string url = "http://www.my-contacts.com/contacts/OAuth20";
                string url = "http://localhost/Contacts/OAuth20";
        ...
        public ActionResult Exchange(string code)
        {
            using (HttpClient client = new HttpClient())
            {
                ...
                //postData.Add(new KeyValuePair<string, string>("redirect_uri", "http://www.my-promo.com/promo/Home/Exchange"));
                postData.Add(new KeyValuePair<string, string>("redirect_uri", "http://localhost/Promo/Home/Exchange"));
                ...
                //                            .Result;
                var tokenResponse = client.PostAsync("http://localhost/Contacts/OAuth20", content)
                                            .Result;
                ...
                if (tokenResponse.IsSuccessStatusCode)
                {
                    ...
                    //                            .Result;
                    var apiResponse = client.GetAsync("http://localhost/Contacts/api/contacts")
                                               .Result;
